<script lang="ts">
  ...
  import {
    ...
    type TorServiceDetectionResult,
    type SystemVpnDetectionResult,
    type WireguardValidationResult,
    type PrivacyEndpointInfo,
  } from '$lib/api/tauri';
  import { privacyShield, isShieldActive, isScreenShareActive, revealedMap } from '$lib/stores/privacyShield';
  ...
  onMount(async () => {
    ...
    // Arka planda tam ağ teşhisini başlat
  ...
  async function checkAi() {
    aiChecking = true;
    try {
      const status = await localAiApi.status();
        ...
        <div class="shield-sub-settings">
          ...
          <div class="shield-preview-card">
            ...
            <div class="preview-secret-row">
              ...
              >
                {privacyShield.formatSecret(DEMO_SECRET, 'demo-test-secret')}
              </div>
              <button
                type="button"
